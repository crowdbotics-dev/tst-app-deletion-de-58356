...
const Untitled2 = () => {
  return <SafeAreaView style={styles.safeArea}>
      ...
      position: 'relative',
      flex: 1
    }} style={styles.ZiaWGDZz}><View style={styles.zrRhvtju}></View><View style={styles.LFmKuelv}></View><View style={styles.msupVSUV}></View><ImageBackground style={styles.SEQhzFMg} source={{
      ...
      }} resizeMode="cover"></ImageBackground><Text style={styles.wJYHeHyZ}>hfjfjmjgb</Text><ActivityIndicator style={styles.QuPQsnWr}></ActivityIndicator><Switch style={styles.sJUKcMpO}></Switch><View style={styles.YLJSEheX}></View><View style={styles.FvmZLQiU}></View></ScrollView>
    <FlatList renderItem={() => <View style={styles.srszVrDf}></View>} ItemSeparatorComponent={() => <View style={styles.TampFTUM} />} data={[1, 2, 3]} keyExtractor={item => item.toString()} style={styles.kjZjKhMP}></FlatList></SafeAreaView>;
};
